    ...
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        ...
        <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
          <Link href="https://ukraineconfidential.com/" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white flex items-center">
            <img src="https://uc-images.s3.eu-de.cloud-object-storage.appdomain.cloud/UC_400x400.png" alt="Ukraine Confidential" className="w-10 h-10 mr-2" />
            <span className="text-xl">Ukraine Confidential</span>
          </Link>
        </div>
        ...
        <div className="navbar-end">
          ...
          <NavElement
            label="Home"
            href="https://ukraineconfidential.com/"
